...
- [ ] Privilege brokers for hardware/admin apps: Security Center uses the narrow root broker; Wi-Fi, updater, App Store, browser setup, and installer transitions remain
