...
- [ ] Privilege brokers for hardware/admin apps: Security Center, Wi-Fi, and Settings run without root; updater, App Store, browser setup, and installer transitions remain
