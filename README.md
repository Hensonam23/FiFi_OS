...
- [ ] Privilege brokers for hardware/admin apps: Security Center and the standalone Wi-Fi manager use the narrow root broker; Settings, updater, App Store, browser setup, and installer transitions remain
