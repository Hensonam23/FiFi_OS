...
- [ ] Privilege brokers for hardware/admin apps: Security Center, Wi-Fi, Settings, and App Store run without root; updater, browser setup, and installer transitions remain
